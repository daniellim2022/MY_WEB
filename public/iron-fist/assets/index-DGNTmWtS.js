 ...
 */var Rg;function MS(){if(Rg)return Uo;Rg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:o,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Uo.Fragment=e,Uo.jsx=i,Uo.jsxs=i,Uo}var Cg;function ES(){return Cg||(Cg=1,Zf.exports=MS()),Zf.exports}var Ne=ES(),Qf={exports:{}},ae={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_a,depthTest:!1,depthWrite:!1})}function kT(o,e,i){const s=new Float32Array(Cs),l=new Z(0,1,0);return new Wi({name:"SphericalGaussianBlur",defines:{n:Cs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Xc(),fragmentShader:`
	...
	`}function XT(o){let e=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===Xh||m===Wh,x=m===Us||m===Lr;if(p||x){let g=e.get(d);const S=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==S)return i===null&&(i=new p_(o)),g=p?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,e.set(d,g),g.texture;if(g!==void 0)return g.texture;{const M=d.image;return p&&M&&M.height>0||x&&M&&l(M)?(i===null&&(i=new p_(o)),g=p?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,e.set(d,g),d.addEventListener("dispose",c),g.texture):null}}}return d}function l(d){let m=0;const p=6;for(let x=0;x<p;x++)d[x]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=e.get(m);p!==void 0&&(e.delete(m),p.dispose())}function h(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:h}}function WT(o){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=o.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&qo("WebGLRenderer: "+s+" extension not supported."),l}}}function qT(o,e,i,s){const l={},c=new WeakMap;function h(g){const S=g.target;S.index!==null&&e.remove(S.index);for(const R in S.attributes)e.remove(S.attributes[R]);S.removeEventListener("dispose",h),delete l[S.id];const M=c.get(S);M&&(e.remove(M),c.delete(S)),s.releaseStatesOfGeometry(S),S.isInstancedBufferGeometry===!0&&delete S._maxInstanceCount,i.memory.geometries--}function d(g,S){return l[S.id]===!0||(S.addEventListener("dispose",h),l[S.id]=!0,i.memory.geometries++),S}function m(g){const S=g.attributes;for(const M in S)e.update(S[M],o.ARRAY_BUFFER)}function p(g){const S=[],M=g.index,R=g.attributes.position;let C=0;if(M!==null){const D=M.array;C=M.version;for(let U=0,L=D.length;U<L;U+=3){const N=D[U+0],I=D[U+1],P=D[U+2];S.push(N,I,I,P,P,N)}}else if(R!==void 0){const D=R.array;C=R.version;for(let U=0,L=D.length/3-1;U<L;U+=3){const N=U+0,I=U+1,P=U+2;S.push(N,I,I,P,P,N)}}else return;const y=new(tv(S)?sv:av)(S,1);y.version=C;const _=c.get(g);_&&e.remove(_),c.set(g,y)}function x(g){const S=c.get(g);if(S){const M=g.index;M!==null&&S.version<M.version&&p(g)}else p(g);return c.get(g)}return{get:d,update:m,getWireframeAttribute:x}}function YT(o,e,i){let s;function l(S){s=S}let c,h;function d(S){c=S.type,h=S.bytesPerElement}function m(S,M){o.drawElements(s,M,c,S*h),i.update(M,s,1)}function p(S,M,R){R!==0&&(o.drawElementsInstanced(s,M,c,S*h,R),i.update(M,s,R))}function x(S,M,R){if(R===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,S,0,R);let y=0;for(let _=0;_<R;_++)y+=M[_];i.update(y,s,1)}function g(S,M,R,C){if(R===0)return;const y=e.get("WEBGL_multi_draw");if(y===null)for(let _=0;_<S.length;_++)p(S[_]/h,M[_],C[_]);else{y.multiDrawElementsInstancedWEBGL(s,M,0,c,S,0,C,0,R);let _=0;for(let D=0;D<R;D++)_+=M[D]*C[D];i.update(_,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=x,this.renderMultiDrawInstances=g}function KT(o){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,h,d){switch(i.calls++,h){case o.TRIANGLES:i.triangles+=d*(c/3);break;case o.LINES:i.lines+=d*(c/2);break;case o.LINE_STRIP:i.lines+=d*(c-1);break;case o.LINE_LOOP:i.lines+=d*c;break;case o.POINTS:i.points+=d*c;break;default:Ce("WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function jT(o,e,i){const s=new WeakMap,l=new nn;function c(h,d,m){const p=h.morphTargetInfluences,x=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,g=x!==void 0?x.length:0;let S=s.get(d);if(S===void 0||S.count!==g){let w=function(){X.dispose(),s.delete(d),d.removeEventListener("dispose",w)};var M=w;S!==void 0&&S.texture.dispose();const R=d.morphAttributes.position!==void 0,C=d.morphAttributes.normal!==void 0,y=d.morphAttributes.color!==void 0,_=d.morphAttributes.position||[],D=d.morphAttributes.normal||[],U=d.morphAttributes.color||[];let L=0;R===!0&&(L=1),C===!0&&(L=2),y===!0&&(L=3);let N=d.attributes.position.count*L,I=1;N>e.maxTextureSize&&(I=Math.ceil(N/e.maxTextureSize),N=e.maxTextureSize);const P=new Float32Array(N*I*4*g),X=new ev(P,N,I,g);X.type=Bi,X.needsUpdate=!0;const T=L*4;for(let H=0;H<g;H++){const j=_[H],J=D[H],ct=U[H],lt=N*I*4*H;for(let B=0;B<j.count;B++){const G=B*T;R===!0&&(l.fromBufferAttribute(j,B),P[lt+G+0]=l.x,P[lt+G+1]=l.y,P[lt+G+2]=l.z,P[lt+G+3]=0),C===!0&&(l.fromBufferAttribute(J,B),P[lt+G+4]=l.x,P[lt+G+5]=l.y,P[lt+G+6]=l.z,P[lt+G+7]=0),y===!0&&(l.fromBufferAttribute(ct,B),P[lt+G+8]=l.x,P[lt+G+9]=l.y,P[lt+G+10]=l.z,P[lt+G+11]=ct.itemSize===4?l.w:1)}}S={count:g,texture:X,size:new ye(N,I)},s.set(d,S),d.addEventListener("dispose",w)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(o,"morphTexture",h.morphTexture,i);else{let R=0;for(let y=0;y<p.length;y++)R+=p[y];const C=d.morphTargetsRelative?1:1-R;m.getUniforms().setValue(o,"morphTargetBaseInfluence",C),m.getUniforms().setValue(o,"morphTargetInfluences",p)}m.getUniforms().setValue(o,"morphTargetsTexture",S.texture,i),m.getUniforms().setValue(o,"morphTargetsTextureSize",S.size)}return{update:c}}function ZT(o,e,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,x=m.geometry,g=e.get(m,x);if(l.get(g)!==p&&(e.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,o.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,o.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const S=m.skeleton;l.get(S)!==p&&(S.update(),l.set(S,p))}return g}function h(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:h}}const QT={[B_]:"LINEAR_TONE_MAPPING",[F_]:"REINHARD_TONE_MAPPING",[H_]:"CINEON_TONE_MAPPING",[G_]:"ACES_FILMIC_TONE_MAPPING",[k_]:"AGX_TONE_MAPPING",[X_]:"NEUTRAL_TONE_MAPPING",[V_]:"CUSTOM_TONE_MAPPING"};function JT(o,e,i,s,l){const c=new Gi(e,i,{type:o,depthBuffer:s,stencilBuffer:l}),h=new Gi(e,i,{type:xa,depthBuffer:!1,stencilBuffer:!1}),d=new si;d.setAttribute("position",new on([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new on([0,2,0,0,2,0],2));const m=new Wy({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const Kb={[B_]:"Linear",[F_]:"Reinhard",[H_]:"Cineon",[G_]:"ACESFilmic",[k_]:"AgX",[X_]:"Neutral",[V_]:"Custom"};function jb(o,e){const i=Kb[e];return i===void 0?(se("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const wc=new Z;function Zb(){be.getLuminanceCoefficients(wc);const o=wc.x.toFixed(4),e=wc.y.toFixed(4),i=wc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+_);const U=D+y+h,L=D+_+d,N=T_(l,l.VERTEX_SHADER,U),I=T_(l,l.FRAGMENT_SHADER,L);l.attachShader(C,N),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function P(H){if(o.debug.checkShaderErrors){const j=l.getProgramInfoLog(C)||"",J=l.getShaderInfoLog(N)||"",ct=l.getShaderInfoLog(I)||"",lt=j.trim(),B=J.trim(),G=ct.trim();let st=!0,yt=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(st=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,N,I);else{const xt=A_(l,N,"vertex"),z=A_(l,I,"fragment");Ce("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
